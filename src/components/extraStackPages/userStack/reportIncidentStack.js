...
import ReportIncident from "../../UserPages/ReportIncident";
...
const ReportIncidentUserStack = ({ navigation, logout }) => {
  return (
    <Stack.Navigator initialRouteName="ReportIncident">
      <Stack.Screen
        name="ReportIncident"
...
export default connect(null, mapDispatchProps)(ReportIncidentUserStack);
